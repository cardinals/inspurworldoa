...
{
    /// <summary>
    /// Default InspurIdentityDbContext that uses the default entity types for ASP.NET Identity Users, Roles, Claims, Logins. 
    /// Use this overload to add your own entity types.
    /// </summary>
    public class InspurIdentityDbContext :
        InspurIdentityDbContext<InspurIdentityUser, InspurIdentityRole, InspurIdentityPermission, string, InspurIdentityUserRole, InspurIdentityRolePermission>
    {
        /// <summary>
        ///     Default constructor which uses the DefaultConnection
        /// </summary>
        public InspurIdentityDbContext()
        ...
        public InspurIdentityDbContext(string nameOrConnectionString)
        ...
        /// </param>
        public InspurIdentityDbContext(DbConnection existingConnection, DbCompiledModel model, bool contextOwnsConnection)
        ...
        /// </summary>
        /// <param name="model">The model that will back this context.</param>
        public InspurIdentityDbContext(DbCompiledModel model)
            : base(model)
        {
        }
        ...
        /// </param>
        public InspurIdentityDbContext(DbConnection existingConnection, bool contextOwnsConnection)
        ...
        /// <param name="model">The model that will back this context.</param>
        public InspurIdentityDbContext(string nameOrConnectionString, DbCompiledModel model)
    ...
    public class InspurIdentityDbContext<TUser> :
        InspurIdentityDbContext<TUser, InspurIdentityRole, InspurIdentityPermission, string, InspurIdentityUserRole, InspurIdentityRolePermission>
        where TUser : InspurIdentityUser
    {
        ...
        public InspurIdentityDbContext(string nameOrConnectionString, bool throwIfV1Schema)
            : base(nameOrConnectionString)
        {
    ...
    /// <summary>
    /// Generic InspurIdentityDbContext base that can be customized with entity types that extend from the base IdentityUserXXX types.
    /// </summary>
    /// <typeparam name="TUser"></typeparam>
    ...
    public class InspurIdentityDbContext<TUser, TRole, TPermission, TKey, TUserRole, TRolePermission> : DbContext
            ...
            IDictionary<object, object> items)
        {
            if (entityEntry != null && entityEntry.State == EntityState.Added)
            {
                ...
                else
                {
                    ...
                    if (role != null && Roles.Any(r => String.Equals(r.RoleName, role.RoleName)))
                    {
                        errors.Add(new DbValidationError("Role",
                            String.Format(CultureInfo.CurrentCulture, IdentityResources.RoleAlreadyExists, role.RoleName)));
                    }
                }
                if (errors.Any())
                {
