...
namespace InspurOA.Identity.Owin.Extensions
{
    ...
    public static class AppBuilderExtensions
    {
        ...
        public static IAppBuilder InspurCreatePerOwinContext<T>(this IAppBuilder app, Func<T> createCallback)
            where T : class, IDisposable
        {
            return InspurCreatePerOwinContext<T>(app, (options, context) => createCallback());
        }
        ...
        /// <returns></returns>
        public static IAppBuilder InspurCreatePerOwinContext<T>(this IAppBuilder app,
            Func<InspurIdentityFactoryOptions<T>, IOwinContext, T> createCallback) where T : class, IDisposable
        {
            if (app == null)
            {
                throw new ArgumentNullException("app");
            }
            return app.InspurCreatePerOwinContext(createCallback, (options, instance) => instance.Dispose());
        }
        ...
        /// <returns></returns>
        public static IAppBuilder InspurCreatePerOwinContext<T>(this IAppBuilder app,
            Func<InspurIdentityFactoryOptions<T>, IOwinContext, T> createCallback,
            Action<InspurIdentityFactoryOptions<T>, T> disposeCallback) where T : class, IDisposable
        {
            if (app == null)
            {
                throw new ArgumentNullException("app");
        ...
        /// </summary>
        /// <param name="app"></param>
        public static void InspurUseExternalSignInCookie(this IAppBuilder app)
        {
            InspurUseExternalSignInCookie(app, DefaultAuthenticationTypes.ExternalCookie);
        }
        ...
        public static void InspurUseExternalSignInCookie(this IAppBuilder app, string externalAuthenticationType)
        {
            if (app == null)
            {
                throw new ArgumentNullException("app");
        ...
        public static void InspurUseTwoFactorSignInCookie(this IAppBuilder app, string authenticationType, TimeSpan expires)
        {
            if (app == null)
            {
                throw new ArgumentNullException("app");
        ...
        /// <param name="app"></param>
        /// <param name="authenticationType"></param>
        public static void InspurUseTwoFactorRememberBrowserCookie(this IAppBuilder app, string authenticationType)
        {
            if (app == null)
            {
                throw new ArgumentNullException("app");
        ...
        public static void InspurUseOAuthBearerTokens(this IAppBuilder app, OAuthAuthorizationServerOptions options)
        {
            if (app == null)
            {
                throw new ArgumentNullException("app");
